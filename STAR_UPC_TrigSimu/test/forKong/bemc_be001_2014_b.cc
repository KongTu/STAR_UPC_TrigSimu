...
void bemc_be001_2014_b(Board& be001)
{
  // INPUT:
  ...
  //  sumTriggerPatchChannels(be001, 0, 5, 1, 1,  lowEtaSum, highTowerBits);
  //  sumTriggerPatchChannels(be001, 6, 9, 1, 1, highEtaSum, highTowerBits);
