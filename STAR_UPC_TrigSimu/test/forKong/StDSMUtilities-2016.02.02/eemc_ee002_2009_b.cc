...
void eemc_ee002_2009_b(Board& ee002)
{
  // INPUT:
  ...
  sumTriggerPatchChannels(ee002, 0, 4, 1, 1, sumJ0, highTowerBitsJ0);
  ...
  sumTriggerPatchChannels(ee002, 5, 9, 1, 1, sumJ1, highTowerBitsJ1);
