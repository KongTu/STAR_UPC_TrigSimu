#include "bits.hh"
#include "Board.hh"
#include "mix_mt101_2015_a.hh"
#include <stdio.h>
void mix_mt101_2015_a(Board& mt101)
{
...
//  const int R3 = mt101.registers[3]; //MTD-DAQ10k-Mode(1)
//  const int R4 = mt101.registers[4]; //MTD-DAQ10k-Test-Pattern(12)
//  const int R5 = mt101.registers[5]; //MTD-DAQ10k-Test-Rate(12)
  const int R6 = mt101.registers[6]; //MTD-Cosmic-Tdiff-Min(10)
  const int R7 = mt101.registers[7]; //MTD-Cosmic-Tdiff-Max(10)
...
//  printf("n_mu=%d\n", nummuons);
  ...
  int tcosmic = mtdtdiff > R6 && mtdtdiff < R7;
