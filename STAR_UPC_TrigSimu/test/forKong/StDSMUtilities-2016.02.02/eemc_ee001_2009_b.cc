...
void eemc_ee001_2009_b(Board& ee001)
{
  // INPUT:
  ...
  sumTriggerPatchChannels(ee001, 0, 8, 2, 3,  lowEtaSum, highTowerBits);
  sumTriggerPatchChannels(ee001, 1, 9, 2, 2, highEtaSum, highTowerBits);
